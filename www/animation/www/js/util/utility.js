...
angular.module('App.Util.Utility', [])
	 ...
	 **********************************************************************************************************/
	 .factory('utility', ['$settings', '$errorHandler', 'assert', '$filter', 
	     ...
	     * Get the url parameter value by key.
	     * Is the value from 'http://localhost:8080/?key=value' 
	     * 
	     * @param key
	     * @returns valueAsString
	     */
	    fUtility.getURLParameter = function(key) {
        	const urlParams = new URLSearchParams(window.location.search);
        	const valueAsString = urlParams.get(key);
        	assert.consoleLog_Control("URL Para: "+key+": "+valueAsString);
